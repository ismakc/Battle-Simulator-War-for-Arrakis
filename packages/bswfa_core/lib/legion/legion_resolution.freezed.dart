...
mixin _$LegionResolution {
  ...
  $LegionResolutionCopyWith<LegionResolution> get copyWith =>
      _$LegionResolutionCopyWithImpl<LegionResolution>(
          this as LegionResolution, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LegionResolution &&
            const DeepCollectionEquality().equals(
                other.appliedChanges, appliedChanges));
  }
  ...
  int get hashCode =>
      Object.hash(
      runtimeType, const DeepCollectionEquality().hash(appliedChanges));
...
abstract mixin class $LegionResolutionCopyWith<$Res> {
  factory $LegionResolutionCopyWith(LegionResolution value,
      $Res Function(LegionResolution) _then) = _$LegionResolutionCopyWithImpl;
...
class _$LegionResolutionCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? appliedChanges = null,}) {
    return _then(_self.copyWith(
      appliedChanges: null == appliedChanges
          ? _self.appliedChanges
          : appliedChanges // ignore: cast_nullable_to_non_nullable
...
extension LegionResolutionPatterns on LegionResolution {
  ...
  TResult Function( _LegionResolution value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _LegionResolution extends LegionResolution {
  const _LegionResolution(
      {final List<LegionChange> appliedChanges = const <LegionChange>[]})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LegionResolutionCopyWith<_LegionResolution> get copyWith =>
      __$LegionResolutionCopyWithImpl<_LegionResolution>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _LegionResolution &&
            const DeepCollectionEquality().equals(
                other._appliedChanges, _appliedChanges));
  }
  ...
  int get hashCode =>
      Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_appliedChanges));
...
/// @nodoc
abstract mixin class _$LegionResolutionCopyWith<$Res>
    implements $LegionResolutionCopyWith<$Res> {
  factory _$LegionResolutionCopyWith(_LegionResolution value,
      $Res Function(_LegionResolution) _then) = __$LegionResolutionCopyWithImpl;
