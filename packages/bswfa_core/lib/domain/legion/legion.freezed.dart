...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Legion value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Legion() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _Legion value)  $default,){
final _that = this;
switch (_that) {
case _Legion():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _Legion value)?  $default,){
final _that = this;
switch (_that) {
case _Legion() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int genericLeaders,  int regularUnits,  int eliteUnits,  int specialEliteUnits,  int usedCards,  List<NamedLeader> namedLeaders)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Legion() when $default != null:
return $default(_that.genericLeaders,_that.regularUnits,_that.eliteUnits,_that.specialEliteUnits,_that.usedCards,_that.namedLeaders);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int genericLeaders,  int regularUnits,  int eliteUnits,  int specialEliteUnits,  int usedCards,  List<NamedLeader> namedLeaders)  $default,) {final _that = this;
switch (_that) {
case _Legion():
return $default(_that.genericLeaders,_that.regularUnits,_that.eliteUnits,_that.specialEliteUnits,_that.usedCards,_that.namedLeaders);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int genericLeaders,  int regularUnits,  int eliteUnits,  int specialEliteUnits,  int usedCards,  List<NamedLeader> namedLeaders)?  $default,) {final _that = this;
switch (_that) {
case _Legion() when $default != null:
return $default(_that.genericLeaders,_that.regularUnits,_that.eliteUnits,_that.specialEliteUnits,_that.usedCards,_that.namedLeaders);case _:
  return null;
