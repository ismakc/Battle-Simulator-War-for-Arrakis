...
mixin _$BattleStatistic {
  ...
  double get attackerHitsStdDeviation;

  double get defenderExpectedHits;

  double get defenderHitsStdDeviation;
  ...
  $BattleStatisticCopyWith<BattleStatistic> get copyWith =>
      _$BattleStatisticCopyWithImpl<BattleStatistic>(
          this as BattleStatistic, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is BattleStatistic &&
            (identical(other.attackerExpectedHits, attackerExpectedHits) ||
                other.attackerExpectedHits == attackerExpectedHits) &&
            (identical(
                other.attackerHitsStdDeviation, attackerHitsStdDeviation) ||
                other.attackerHitsStdDeviation == attackerHitsStdDeviation) &&
  ...
  int get hashCode =>
      Object.hash(
      runtimeType, attackerExpectedHits, attackerHitsStdDeviation,
      defenderExpectedHits, defenderHitsStdDeviation);
...
abstract mixin class $BattleStatisticCopyWith<$Res> {
  factory $BattleStatisticCopyWith(BattleStatistic value,
      $Res Function(BattleStatistic) _then) = _$BattleStatisticCopyWithImpl;
...
class _$BattleStatisticCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? attackerExpectedHits = null, Object? attackerHitsStdDeviation = null, Object? defenderExpectedHits = null, Object? defenderHitsStdDeviation = null,}) {
    return _then(_self.copyWith(
      attackerExpectedHits: null == attackerExpectedHits
          ? _self.attackerExpectedHits
          : attackerExpectedHits // ignore: cast_nullable_to_non_nullable
      as double,
      attackerHitsStdDeviation: null == attackerHitsStdDeviation
          ? _self.attackerHitsStdDeviation
          : attackerHitsStdDeviation // ignore: cast_nullable_to_non_nullable
      as double,
      defenderExpectedHits: null == defenderExpectedHits
          ? _self.defenderExpectedHits
          : defenderExpectedHits // ignore: cast_nullable_to_non_nullable
      as double,
      defenderHitsStdDeviation: null == defenderHitsStdDeviation
          ? _self.defenderHitsStdDeviation
          : defenderHitsStdDeviation // ignore: cast_nullable_to_non_nullable
      as double,
    ));
  }
...
extension BattleStatisticPatterns on BattleStatistic {
  ...
  TResult Function( _BattleStatistic value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _BattleStatistic extends BattleStatistic {
  const _BattleStatistic(
      {this.attackerExpectedHits = .0, this.attackerHitsStdDeviation = .0, this.defenderExpectedHits = .0, this.defenderHitsStdDeviation = .0})
      : super._();
  ...
  @override
  @JsonKey()
  final double attackerHitsStdDeviation;
  @override
  @JsonKey()
  final double defenderExpectedHits;
  @override
  @JsonKey()
  final double defenderHitsStdDeviation;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BattleStatisticCopyWith<_BattleStatistic> get copyWith =>
      __$BattleStatisticCopyWithImpl<_BattleStatistic>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _BattleStatistic &&
            (identical(other.attackerExpectedHits, attackerExpectedHits) ||
                other.attackerExpectedHits == attackerExpectedHits) &&
            (identical(
                other.attackerHitsStdDeviation, attackerHitsStdDeviation) ||
...
/// @nodoc
abstract mixin class _$BattleStatisticCopyWith<$Res>
    implements $BattleStatisticCopyWith<$Res> {
  factory _$BattleStatisticCopyWith(_BattleStatistic value,
      $Res Function(_BattleStatistic) _then) = __$BattleStatisticCopyWithImpl;
