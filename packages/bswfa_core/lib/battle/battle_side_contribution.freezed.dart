...
mixin _$BattleSideContribution {
  ...
  int get leaderActivatedSwords;

  int get leaderActivatedShields;

  /// Create a copy of BattleSideContribution
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $BattleSideContributionCopyWith<BattleSideContribution> get copyWith =>
      _$BattleSideContributionCopyWithImpl<BattleSideContribution>(
          this as BattleSideContribution, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is BattleSideContribution &&
            (identical(other.swords, swords) || other.swords == swords) &&
            (identical(other.shields, shields) || other.shields == shields) &&
            (identical(other.leaderActivatedSwords, leaderActivatedSwords) ||
                other.leaderActivatedSwords == leaderActivatedSwords) &&
            (identical(other.leaderActivatedShields, leaderActivatedShields) ||
                other.leaderActivatedShields == leaderActivatedShields));
  }
  ...
  int get hashCode =>
      Object.hash(
      runtimeType, swords, shields, leaderActivatedSwords,
      leaderActivatedShields);
...
abstract mixin class $BattleSideContributionCopyWith<$Res> {
  factory $BattleSideContributionCopyWith(BattleSideContribution value,
      $Res Function(BattleSideContribution) _then) = _$BattleSideContributionCopyWithImpl;
...
class _$BattleSideContributionCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? swords = null, Object? shields = null, Object? leaderActivatedSwords = null, Object? leaderActivatedShields = null,}) {
    return _then(_self.copyWith(
      swords: null == swords
          ? _self.swords
          : swords // ignore: cast_nullable_to_non_nullable
      as int,
      shields: null == shields
          ? _self.shields
          : shields // ignore: cast_nullable_to_non_nullable
      as int,
      leaderActivatedSwords: null == leaderActivatedSwords
          ? _self.leaderActivatedSwords
          : leaderActivatedSwords // ignore: cast_nullable_to_non_nullable
      as int,
      leaderActivatedShields: null == leaderActivatedShields
          ? _self.leaderActivatedShields
          : leaderActivatedShields // ignore: cast_nullable_to_non_nullable
      as int,
    ));
  }
...
extension BattleSideContributionPatterns on BattleSideContribution {
  ...
  TResult Function( _BattleSideContribution value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _BattleSideContribution extends BattleSideContribution {
  const _BattleSideContribution(
      {this.swords = 0, this.shields = 0, this.leaderActivatedSwords = 0, this.leaderActivatedShields = 0})
      : super._();
  ...
  @override
  @JsonKey()
  final int leaderActivatedSwords;
  @override
  @JsonKey()
  final int leaderActivatedShields;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BattleSideContributionCopyWith<_BattleSideContribution> get copyWith =>
      __$BattleSideContributionCopyWithImpl<_BattleSideContribution>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _BattleSideContribution &&
            (identical(other.swords, swords) || other.swords == swords) &&
            (identical(other.shields, shields) || other.shields == shields) &&
            (identical(other.leaderActivatedSwords, leaderActivatedSwords) ||
                other.leaderActivatedSwords == leaderActivatedSwords) &&
...
/// @nodoc
abstract mixin class _$BattleSideContributionCopyWith<$Res>
    implements $BattleSideContributionCopyWith<$Res> {
  factory _$BattleSideContributionCopyWith(_BattleSideContribution value,
      $Res Function(_BattleSideContribution) _then) = __$BattleSideContributionCopyWithImpl;
