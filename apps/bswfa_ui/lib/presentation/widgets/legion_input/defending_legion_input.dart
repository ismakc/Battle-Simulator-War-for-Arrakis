    ...
    >(
      ...
      builder: (BuildContext context, DefendingLegion state) {
        return LabeledBorderFieldset(
          label:
              'Defending Legion ( ${state.diceCount}\u{1F3B2}of ${state.unlimitedDiceCount}/  ${state.maxStarsCount}\u{2B50}of ${state.unlimitedStarsCount}  /  -${state.removedShieldsCount}\u{1F6E1}  /  ${state.remainingLossCapacity}\u{2764}\u{FE0F} )',
